...
class AerovalJsonFileDB(AerovalDB):
    def __init__(self, basedir: str | Path):
        ...
        self.PATH_LOOKUP = {
            ...
            "/v0/contour/{project}/{experiment}/{modvar}/{model}": "./{project}/{experiment}/contour/{modvar}_{model}.geojson",
            ...
            "/v0/report/{project}/{experiment}/{title}": "./reports/{project}/{experiment}/contour/{title}.json",
        }
