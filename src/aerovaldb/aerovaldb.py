...
class AerovalDB(abc.ABC):
    ...
    def get_contour(self, project: str, experiment: str, modvar: str, model: str, /, *args, **kwargs):
    ...
    def put_contour(self, obj, project: str, experiment: str, modvar: str, model: str, /, *args, **kwargs):
